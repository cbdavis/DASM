...
### Add up multiple probability densities
...
A [Q-Q plot](https://en.wikipedia.org/wiki/Q%E2%80%93Q_plot) can be used to see if the values in a sample are normally distributed.  
...
xi has then at least a fraction of Pi data values smaller than xi.
...
#### Exercise on real-world data sets
