...
**TODO** need segway to plot below
```{r}
...
(have the students do the t.test in the correct way)
...
**TODO**  this syntax will not work if you copy/paste
...
### Exercise - Two sample t-test - paired
