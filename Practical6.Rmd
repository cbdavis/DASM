...
**TODO** Anscombe's quartet `?anscombe` - could make demonstrations with this dataset, show cook's distance, etc.  Use Anscombe's quartet to show the things above.  Use this as a recurring example - here, with the residuals, then with Cook's distance.
...
**TODO** show first method using geom_abline, don't use geom_smooth, can maybe mention it.

**TODO** explain what coefficients mean - have (Intercept) and then x - one is the slope - this will show up again with the multiple regression
