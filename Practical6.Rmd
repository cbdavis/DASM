...
**TODO** explain how names of colors turn into factors, etc
```{r}
ggplot(anscombe1) + 
...
**TODO** this should be for both weighted and unweighted regressions?
...
Make a Reduced major axis regression for x and y in data 1 and add the line to the plot 

**TODO** use anscombe1 data for the example, and then let them use the Practical6_data.txt file here for the exercise
