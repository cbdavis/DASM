...
ggplot(data1, aes(x=month, y=cal)) + geom_boxplot()
...
# Try on your own: 
find another data set where data can be grouped and the means calculated by group, also let them make a box plot

**TODO** give them a list of datasets to pick from?