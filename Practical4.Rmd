...
### 2.2 Syntax of chi-square test for goodness of fit
...
We can calculate this through a series of vector operations by hand:
...
can see that the variance is not completely equal.  
Note that you might need to specify `x=as.factor(gear)` for ggplot to plot things correctly.
