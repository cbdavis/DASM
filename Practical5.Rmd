...
* Construct a normal distribution $f_{n,u}$ using the mean of $u$ and a standard deviation $s_u$ 
* Construct a normal distribution $f_{n,v}$ using the mean of $v$ and a standard deviation $s_v$
...
Below we can see how both the mean and the standard deviation converge on a single value as we increase the number of samples from the distributions we defined for $p$ and $q$ (See page 33,34 of Lecture 7).  Note the log scale for the x axis.
